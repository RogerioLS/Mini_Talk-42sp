...
/*   Updated: 2024/01/25 15:25:56 by roglopes         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * 
 * @include unistd -> Including unistd.h in a C program provides access
 * to various POSIX (Portable Operating System Interface) functions 
 * related to system calls, file operations, 
 * and other low-level functionalities;
 * 
 * @include stdlib -> The #include <stdlib.h> directive in C is 
 * used to include the standard library header file named stdlib.h. 
 * This header file provides declarations for several functions 
 * involving memory allocation, process control, and other 
